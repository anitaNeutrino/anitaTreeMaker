...
void fixedWingRestrictedRootifier()
{

  TFile f("baseList.root","update");
  TTree fixedWingTree("fixedWingRestrictedTree","TTree filled with restricted USAP Fixed Wing Landing Sites");
  ...
  // Load base list
  std::ifstream ifile("./data/convertedFiles/base_list-restricted-A4.csv.5");
...
*/
  ...
  fixedWingTree.Write();
  std::cout << "fixedWingRestrictedTree written" << std::endl;
