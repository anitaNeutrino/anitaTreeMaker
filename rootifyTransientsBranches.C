/*  Macro written by John Russell to place transient data into ROOT binaries for ANITA 3 and 4. Places TLeaves into
 	TBranches corresponding to vehicle's call sign.  */
